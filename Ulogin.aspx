					...
					<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="Uregister.aspx">Register</a></li>
					...
					<div class="row fullscreen align-items-center justify-content-between">
						...
						<div class="col-lg-4 col-md-6 banner-right">
							...
							<form class="form-wrap"  id="form2" runat="server" >
									<input type="text" class="form-control" id="uname" runat="server" name="name" placeholder="User Name " onfocus="this.placeholder = ''" onblur="this.placeholder = 'User name '"/>									
									...
									<asp:Button ID="Button1" runat="server"  class="primary-btn text-uppercase" Text="Login" OnClick="Button1_Click" />								
								</form>		
