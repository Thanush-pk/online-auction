<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sellerpage.aspx.cs" Inherits="sellerpage" %>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<div class="nav_right_top">
                           ...
                           <li class="active">
							...
							<li>
								<a class="scroll" href="ViewPrd.aspx" style="color:black">View Products</a>
							</li>
							<li>
								<a class="scroll" href="SellerGrant.aspx" style="color:black">Approve Product</a>
							</li>
							<li>
				...
				<table class="style1" style="color:white;font-size:18px;font-weight:bold;">
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <span style="font-weight:bolder;font-size:25px;color:green;">Seller page  !!!</span></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                     ...
                     <%--   <input type="date" --%>
                        ...
                        <td>
                        &nbsp;
                      <asp:FileUpload  id="lfile" runat="server"  style="margin-top:3%;"/>
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <input id="login" type="submit" value="Submit" runat="server" onserverclick="login_ServerClick"  class="button button1" /></td>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
