    ...
    <div style="padding-top:100px;min-height:560px;background-color:#b3b3ff;" class="col-md-12">
           ...
           BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" EnableModelValidation="True"> <%--OnRowCommand="adgrid_RowCommand1"--%>
            <Columns>
                 ...
                 <asp:BoundField DataField="id"        HeaderText="ID"     ItemStyle-Width="80px" ItemStyle-Height="40px"   ControlStyle-BackColor="Wheat"/>
                 <asp:BoundField DataField="name"        HeaderText="Name"     ItemStyle-Width="80px" ItemStyle-Height="40px"   ControlStyle-BackColor="Wheat"/>
                  <asp:BoundField DataField="feed"         HeaderText="Feedback"      ItemStyle-Width="80px" ItemStyle-Height="40px"   ControlStyle-BackColor="Wheat"/>
