<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminViewbid.aspx.cs" Inherits="AdminViewbid" %>
...
<body>
       ...
       <div id="FormBody" style="padding:110px;background-size: cover;min-height:900px;background-image:url('images/seller.png');">
           ...
           <div style="width:40%;float:left;padding-left:-1px;color:white;">
            	
             <form id="form1" runat="server" method="post">
			 <asp:GridView ID="adgrid3" runat="server" AutoGenerateColumns="false"  EmptyDataText="There are no data records to display."     STYLE="margin-top:10%;margin-left:-10%; color:white;"  GridLines="Horizontal" Width="1100px" 
           BorderColor="#336666" BorderStyle="Double" CellPadding="4" BorderWidth="3px" OnRowDeleting="adgrid3_RowDeleting" EnableModelValidation="True"> <%--OnRowCommand="adgrid_RowCommand1"--%>
            <Columns>


                 <asp:BoundField DataField="Pid"    HeaderText="Id"  ItemStyle-Width="80px" ItemStyle-Height="40px" HeaderStyle-HorizontalAlign="Center"  ControlStyle-BackColor="Wheat"/>
        <asp:BoundField DataField="SellerName"        HeaderText="Seller Name"     ItemStyle-Width="80px" ItemStyle-Height="40px"   ControlStyle-BackColor="Wheat"/>
            
             <asp:BoundField DataField="BuyName"         HeaderText="Buyer Name"      ItemStyle-Width="80px" ItemStyle-Height="40px"   ControlStyle-BackColor="Wheat"/>
            
             <asp:BoundField DataField="Amount"       HeaderText="Bidded Amount"  ItemStyle-Width="80px" ItemStyle-Height="40px"   ControlStyle-BackColor="Wheat"/>
...
<asp:LinkButton ID="lbDelete" runat="server"  CommandName="Delete" Text="Delete"/>
               ...
               <%--    <h2>Admin</h2>
                 	 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowDeleting="GridView1_RowDeleting"   EmptyDataText="There are no data records to display."     STYLE="margin-top:10%;margin-left:-10%; color:white;"  GridLines="Horizontal" Width="800px" 
