<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manageproduct.aspx.cs" Inherits="index" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
           ...
           <%-- <h3>Manage Products page !!!</h3><br />--%>
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ProdId" HeaderText="Product Id" 
                         ...
                         <asp:BoundField DataField="ProdName" HeaderText="Product Name" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="ProdName" />
                            <asp:BoundField DataField="ProdVer" HeaderText="Version" 
                            SortExpression="ProdVer" />  
                        <asp:BoundField DataField="YOM" HeaderText="Manufacturing Year" 
                            SortExpression="YOM" />  
                            <asp:BoundField DataField="ProdType" HeaderText="Product Type" 
             ...
             <!-- <table class="container" style="">
              <tr>
                  ...
                  <hr />
                  <h3>
                      Manage Product Added By Seller
                  </h3>

                   <asp:GridView ID="adgrid3" runat="server" AutoGenerateColumns="false" OnRowDeleting="adgrid3_RowDeleting"   EmptyDataText="There are no data records to display."     STYLE="margin-top:10%;margin-left:10%; color:white;"  GridLines="Horizontal" Width="800px" 
