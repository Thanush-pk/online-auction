<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BidView.aspx.cs" Inherits="BidView" %>
...
<body>
       ...
       <div id="FormBody" style="padding:110px;background-size: cover;min-height:900px;background-image:url('images/21.jpg');background-position:center;background-repeat:no-repeat;background-size:cover">
           ...
           <h2 style="color:white">Product Sold By Seller</h2>
            ...
            <ItemTemplate>
                <asp:Image ID="img2" runat="server" height="100px" Width="80px" ImageUrl='<%# String.Format("~/images/{0}",Eval("File")) %>'/>
				 ...
				 <asp:BoundField DataField="Ldate"    HeaderText="Last Date"  ItemStyle-Width="80px" ItemStyle-Height="40px"   ControlStyle-BackColor="Wheat"/>
                     ...
                     <asp:BoundField DataField="desct"    HeaderText="Description"  ItemStyle-Width="80px" ItemStyle-Height="40px"   ControlStyle-BackColor="Wheat"/>


                   <asp:ButtonField Text="Bid" CommandName="select" ItemStyle-Width="150" />
               <%--   <asp:TemplateField>
<ItemTemplate>
...
<asp:LinkButton ID="lbDelete" runat="server"  CommandName="Delete" Text="Delete"/>
               ...
               <label style="color:gold;font-weight:bold">Bidding Amount :</label>  <input type="text" id="cst" runat="server" />
            ...
            <%--      <h2 style="color:white">Product Sold By Admin</h2>
